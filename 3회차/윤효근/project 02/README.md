...
## 후기
 ...
 Django 컨트롤을 위한 연습이였다

환경 변수 사용법에 알게 되었으며

람다 함수의 실 사용을 통해 조금 더 클린한 코딩을 할 수 있었다
...
- API키를 GitHub에 노출시키지 않지만 로컬에서는 활용하기 위해서는 프로젝트에서 환경 변수 파일을 
  ...
  - 파이썬에서는 https://github.com/theskumar/python-dotenv를 많이 사용합니다.
